...
delete_parser = subparsers.add_parser(
    ...
    usage='pyfile delete <dir_path_1> ... <dir_path_i> [--size MIN MAX] [--name MIN MAX] [--file_types FILE_TYPE_1 ... FILE_TYPE_i] [--date DD.MM.YY  DD.MM.YY] [--only_empty]',
)
...
delete_parser.add_argument('--date', nargs=2, metavar=('START', 'END'), help='Delete files modified within the given date range (YYYY-MM-DD)', default=None)
